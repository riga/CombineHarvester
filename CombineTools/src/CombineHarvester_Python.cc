...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(defaults_ExtractShapes, ExtractShapes, 3, 4)
...
BOOST_PYTHON_MODULE(libCombineHarvesterCombineTools)
{
  ...
  py::class_<CombineHarvester>("CombineHarvester")
      ...
      .def("ExtractShapes", &CombineHarvester::ExtractShapes, defaults_ExtractShapes())
